...
export class HttpService {
  ...
  getRecipeDetail(query: string): Observable<RecipieDetail> {
    const _link =
      'https://api.edamam.com/api/recipes/v2/' +
      query +
      '?type=public&app_id=c395f4a9&app_key=a5a8e229ca6add8577558feac16a459a';
    return this.http.get<RecipieDetail>(_link);
  }
}
